...
import { Check, ChevronLeft, ChevronRight, Circle, Clock3, UserRound } from 'lucide-react';
import {
  addDays,
  api,
  formatWeekRange,
      ...
      <Card className='moradi-glass-panel rounded-3xl border-white/75'>
        <CardHeader className='space-y-4 p-5'>
          <div className='flex flex-wrap items-start justify-between gap-4'>
            <div>
              <p className='text-[10px] font-semibold uppercase tracking-[0.24em] text-sky-700/75'>{t('title')}</p>
                ...
                return (
                  <Card
                    ...
                    className={cn(
                      ...
                      isToday && 'border-blue-300/90 bg-blue-50/90'
                    )}
                  >
