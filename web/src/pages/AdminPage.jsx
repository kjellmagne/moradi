...
const TEXT = {
  en: {
    ...
    deadlineTemplateNo: 'Deadline template (Norwegian)',
    deadlineTemplateEn: 'Deadline template (English)',
    weeklyTemplateNo: 'Weekly reminder template (Norwegian)',
    weeklyTemplateEn: 'Weekly reminder template (English)',
    deadlineTemplateHint: 'Deadline: {chore}, {due_time}, {person}, {mobile_url}',
    weeklyTemplateHint: 'Weekly: {person}, {week_number}, {week_range}, {mobile_url}',
  ...
  no: {
    ...
    templatePlaceholders: 'Plassholdere',
    deadlineTemplateNo: 'Fristmal (norsk)',
    deadlineTemplateEn: 'Fristmal (engelsk)',
    weeklyTemplateNo: 'Ukevarselmal (norsk)',
    weeklyTemplateEn: 'Ukevarselmal (engelsk)',
    deadlineTemplateHint: 'Frist: {chore}, {due_time}, {person}, {mobile_url}',
    weeklyTemplateHint: 'Ukevarsel: {person}, {week_number}, {week_range}, {mobile_url}',
...
export function AdminPage() {
  ...
  function normalizedSettingsPayload(form) {
    ...
    return {
      ...
      deadline_message_template_en: String(source.deadline_message_template_en || '').trim(),
      deadline_message_template_no: String(source.deadline_message_template_no || '').trim(),
      weekly_owner_message_template_en: String(source.weekly_owner_message_template_en || '').trim(),
      weekly_owner_message_template_no: String(source.weekly_owner_message_template_no || '').trim(),
